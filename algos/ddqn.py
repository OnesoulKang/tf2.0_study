...
class Agent:
    ...
    def update(self):
        ...
        with tf.GradientTape() as tape:
            ...
            # get main q value of states 
            # get main value using action and q value from main network
